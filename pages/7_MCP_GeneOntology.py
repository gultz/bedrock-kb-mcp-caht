...
st.title("MCP Page")
st.write("This is the MCP page content.")
...
if query:
    # Session에 메세지 저장
    st.session_state.mcp_messages.append({"role": "user", "content": query})
    ...
    # Session 메세지 저장
    st.session_state.mcp_messages.append({"role": "assistant", "content": answer})
